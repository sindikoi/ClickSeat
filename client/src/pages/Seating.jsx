...
const Seating = () => {
  ...
  const handleTableDrop = (e, table) => {
    ...
    if (draggedGuest && table.guests.length < table.capacity) {
      ...
      setTables((prevTables) =>
        prevTables.map((t) =>
          t.id === table.id ? { ...t, guests: [...t.guests, draggedGuest] } : t
        )
      );
    }
  ...
  const handleEditTable = (table) => {
    ...
    setNewTable({
      ...
      capacityType:
        table.capacity >= 2 && table.capacity <= 20 ? 'preset' : 'custom',
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: getStatusColor(guest.rsvpStatus),
                      }}
                    >
                    ...
                    {isSeated && (
                      <span className="seated-indicator">✓ הושב</span>
                    )}
                  </div>
                );
              })
