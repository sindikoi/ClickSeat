...
const Guests = () => {
  ...
  const filteredGuests = guests.filter((guest) => {
    ...
    const matchesStatus =
      statusFilter === 'all' ? true : guest.rsvpStatus === statusFilter;
  ...
  // סטטיסטיקות
  const totalGuests = guests.filter((g) =>
    selectedEvent ? g.eventId === selectedEvent : true
  ).length;
              ...
              <div className="empty-state">
                ...
                <p>
                  {searchTerm || statusFilter !== 'all'
                    ? 'לא נמצאו אורחים התואמים לפילטרים שלך'
                    : 'הוסף את האורח הראשון שלך!'}
                </p>
              </div>
            ) : (
                      ...
                      <div className="guest-actions">
                        ...
                        <div className="status-buttons">
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleStatusChange(guest.id, 'pending')
                            }
                            title="לא הגיב"
                          >
                            ⏳
